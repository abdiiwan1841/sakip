...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Detail Renbut Tahap 1</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Detail Renja</h2>
        </header>
		{!! Form::open(['url' => '/editrenaku1', 'class' => 'form-horizontal', 'files' => true]) !!}
				...
				foreach($asd as $value4){?>
						...
						foreach($sub as $value6){?>
								<tr>
									...
									<td>
                    @if($value->status == 5)
                    <center><a target="_blank" class="btn btn-info" href="{{url('/cetak_renbin/'.$value4->id_jawaban)}}"><i class="fa fa-print"></i></a></center></td>
                    @endif
                </tr>
						<?php } ?>
