				...
				<div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <label class="form-label">{{$apbn->feedback}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-group col-lg-10" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id" value="{{$apbn->id_perencanaan_kegiatan}}">
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_kerangka_acuan_kegiatan" value="{{$apbn->id_kerangka_acuan_kegiatan}}">
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_uraian_kegiatan_rincian_biaya" value="{{$apbn->id_uraian_kegiatan_rincian_biaya}}">
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_uraian_biaya_administrasi" value="{{$apbn->id_uraian_biaya_administrasi}}">
                                </h4>
                            </div>
						...
						<div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_syarat_teknis" value="{{$apbn->id_syarat_teknis}}">
                                </h4>
                            </div>
						...
						<div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_gambar_denah" value="{{$apbn->id_gambar_denah}}">
                                </h4>
                            </div>
						...
						<div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_bagan_organisasi" value="{{$apbn->id_bagan_organisasi}}">
                                </h4>
                            </div>
						...
						<div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
									...
									<input type="hidden" name="id_surat_pernyataan_mutlak" value="{{$apbn->id_surat_pernyataan_mutlak}}">
                                </h4>
                            </div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<a href="{{ url('/terimarengiat',$apbn->id_perencanaan_kegiatan)}}" class="btn btn-success">Terima</a>
							</div>
						</div>
