                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($apbn as $apbn_val)
                            <tr>
								...
								@else
									@if($apbn_val->status_ == 2)
										<a title="view" href="{{ url('/checklist_rengiat_apbn',$apbn_val->id_perencanaan_kegiatan)}}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-search"></span></a>
									@elseif($apbn_val->status_ == 3)
									...
									@else
										<a title="view" href="{{ url('/checklist_rengiat_apbn',$apbn_val->id_perencanaan_kegiatan)}}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-search"></span></a>
									@endif
								@endif
									</center></td>
                            </tr>
                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        @foreach($pnbp as $pnbp_val)
                            <tr>
								...
								@else
									@if($pnbp_val->status_ == 2)
										<a title="view" href="{{ url('/checklist_rengiat_pnbp',$pnbp_val->id_perencanaan_kegiatan)}}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-search"></span></a>
									@elseif($pnbp_val->status_ == 3)
									...
									@else
										<a title="view" href="{{ url('/checklist_rengiat_pnbp',$pnbp_val->id_perencanaan_kegiatan)}}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-search"></span></a>
									@endif
								@endif
								</center></td>
                            </tr>
