...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Form Penyusunan Biaya Administrasi PNBP</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Form Penyusunan Biaya Administrasi PNBP</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Form Penyusunan Biaya Administrasi PNBP</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="waktu_pelaksanaan" type="text" value="" id="waktu_pelaksanaan">
