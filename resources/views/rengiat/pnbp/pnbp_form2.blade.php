...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Form Kerangka Acuan Kegiatan PNBP</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Form Kerangka Acuan Kegiatan PNBP</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Form Kerangka Acuan Kegiatan PNBP</h2>
        </header>
            ...
            <div class="tab-content">
                ...
                <div id="home" class="tab-pane fade in active">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input class="form-control" name="volume_keluaran" type="text" value=""
                                   id="volume_keluaran">
                        </div>
                    </div>
