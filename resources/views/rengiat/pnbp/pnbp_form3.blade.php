...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Form Rincian Anggaran Biaya PNBP</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Form Rincian Anggaran Biaya PNBP</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Form Rincian Anggaran Biaya PNBP</h2>
        </header>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="kementerian" type="text" value="<?php echo $list->kementrian_negara_lembaga; ?>" id="kementerian">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="keluaran" type="text" value="<?php echo $list->keluaran; ?>" id="keluaran">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="detil_kegiatan" type="text" value="<?php echo $list->detail_kegiatan; ?>" id="detil_kegiatan">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="volume" type="text" value="<?php echo $list->volume_keluaran; ?>" id="volume">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="satuan_ukur" type="text" value="<?php echo $list->satuan_ukur_keluaran; ?>" id="satuan_ukur">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="alokasi_dana" type="text" value="<?php echo buatrp($list->biaya_yang_diperlukan); ?>" id="alokasi_dana">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input class="form-control" name="harga_material" type="number" value="" id="harga_material">
                </div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input class="form-control" readonly name="total_biaya_fisik" type="hidden" value="" id="total_biaya_fisik">
                    <input class="form-control" readonly type="text" value="" id="total_biaya_fisik2">
                </div>
            </div>
