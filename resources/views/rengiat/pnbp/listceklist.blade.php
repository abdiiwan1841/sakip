...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Form List Ceklist PNBP</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Form List Ceklist PNBP</h2>
        </header>
...
-->
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form1/'.$list->id_perencanaan_kegiatan) }}">Surat Pengantar
                                Kalakgiat</a></center>
                    </th>
                    <th>
				...
				<tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form9/'.$list->id_perencanaan_kegiatan) }}">Upload Rencana Kegiatan</a></center>
                    </th>
                    <th>
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form2/'.$list->id_perencanaan_kegiatan) }}">Kerangka Acuan
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form3/'.$list->id_perencanaan_kegiatan) }}">Uraian Kegiatan dan
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form4/'.$list->id_perencanaan_kegiatan) }}">Uraian dan Perincian
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form5/'.$list->id_perencanaan_kegiatan) }}">Syarat - Syarat teknis
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form6/'.$list->id_perencanaan_kegiatan) }}">Gambar/Denah</a>
                        </center>
                    </th>
                    <th>
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form7/'.$list->id_perencanaan_kegiatan) }}">Bagan Organisasi
                                Kegiatan</a></center>
                    </th>
                    <th>
                ...
                <tr>
                    ...
                    <th>
                        <center><a href="{{ url('pnbp_form8/'.$list->id_perencanaan_kegiatan) }}">Surat Pernyataan
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <a href="{{ url('/rengiat_pnbp')}}" class="btn btn-danger">Kembali ke Rencana Kegiatan PNBP</a>
                </div>
            </div>
            <?php } ?>
            {{Form::close()}}
