...
<section role="main" class="content-body">
	...
	<br>
        <ul id="myTab" class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#menu1">APBN</a></li>
        </ul>
		...
		<div class="tab-content">
            <div id="home" class="tab-pane fade in active">
				<header class="panel-heading">
                    ...
                    <h2 class="panel-title">Tambah Rencana Kegiatan Apbn bedasarkan Renbut</h2>
                </header>
                    ...
                    <table class="table table-bordered" id="users-table2">
						...
						@foreach($apbn as $value2)
							<tr>
								...
								<td><center>
									<a href="{{ url('/tambah_rengiat_apbn',$value2->id_jawaban)}}" class="btn btn-sm btn-primary"><span class="fa fa-plus"></span></a>
									</center>
								</td>
							</tr>
						@endforeach
						...
						<ul class="nav wizard-steps">
							...
							<li class="nav-item active" style="width:230px; ">
								<a style="background-color:#007bff !important; color: #fff;"
								   href="{{ url('tambah_rengiat_apbn') }}" class="nav-link text-center">
