        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" readonly name="alokasi_dana" type="hidden" value="<?php echo $list->biaya_yang_diperlukan; ?>" id="alokasi_dana">

                     <input class="form-control" readonly type="text" value="<?php echo buatrp($list->biaya_yang_diperlukan); ?>">
