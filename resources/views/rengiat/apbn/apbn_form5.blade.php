        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="kementerian" type="text" value="<?php echo $list->kementrian_negara_lembaga; ?>" id="kementerian">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="keluaran" type="text" value="<?php echo $list->keluaran; ?>" id="keluaran">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="detil_kegiatan" type="text" value="<?php echo $list->detail_kegiatan; ?>" id="detil_kegiatan">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="volume" type="text" value="<?php echo $list->volume_keluaran; ?>" id="volume">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="satuan_ukur" type="text" value="<?php echo $list->satuan_ukur_keluaran; ?>" id="satuan_ukur">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <input class="form-control" name="alokasi_dana" type="text" value="<?php echo buatrp($list->biaya_yang_diperlukan);  ?>" id="alokasi_dana">
