                    ...
                    <!-- start: page -->
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Master Program</h2>
                            </header>
                           ...
                           <div class="wizard-tabs" style="float: left !important;">
                                    <ul class="nav wizard-steps">
                                         ...
                                         <li class="nav-item" style="width:230px; ">
                                            <a href="{{ url('program_add') }}"  class="nav-link text-center" style="background-color:#007bff !important; color: #fff;">
                            ...
                            <tr>
                                ...
                                <td><center>
                                    <a title="hapus" href="{{ url('/program_edit',$list->id_program)}}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
                                    {!! Form::open([
                                        'method'=>'DELETE',
                                        'url' => ['/list_program', $list->id_program],
