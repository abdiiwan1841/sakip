...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Master Kegiatan</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Master Kegiatan</h2>
        </header>
        <div class="panel-body">
            <div class="wizard-tabs" style="float: left !important;">
                <ul class="nav wizard-steps">
                    ...
                    <li class="nav-item" style="width:230px; ">
                        <a href="{{ url('kegiatan_add') }}" class="nav-link text-center"
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($kegiatan_list as $list){ ?>
                <tr>
                    <td>
                        <center>{{$no}}</center>
                    </td>
                    <td>
                        <center>{{$list->nama_program}}</center>
                    </td>
                    <td>
                        <center>{{$list->nama_kegiatan}}</center>
                    </td>
                    <td>
                        <center>{{$list->keterangan_kegiatan }}</center>
                    </td>

                    <td>
                        <center>
                            <a title="hapus" href="{{ url('/kegiatan_edit',$list->id_kegiatan)}}"
                               class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
                            {!! Form::open([
                                'method'=>'DELETE',
                                'url' => ['/list_kegiatan', $list->id_kegiatan],
